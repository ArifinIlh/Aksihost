...
@section('title', 'Tambah Harga Domain')

@section('content')
<div class="container">
    <div class="row mb-3">
        <div class="col">
            <h3>Tambah Harga Domain</h3>
        </div>
    </div>
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tambah Ekstensi</li>
        </ol>
    </nav>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <strong>Form Tambah Ekstensi Domain</strong>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.domain-prices.store') }}" method="POST" novalidate>
                        @csrf
